...
namespace Vetotvet.Controllers
{
    public class BreedsController : Controller
    {
        ...
        public BreedsController(VetotvetDbContext context)
        {
            _context = context;
        }
        ...
        {
            var vetotvetDbContext = _context.Breeds.Include(b => b.KindOfAnimal);
            return View(await vetotvetDbContext.ToListAsync());
        }
        ...
        {
            ViewData["KindOfAnimalId"] = new SelectList(_context.KindOfAnimals, "Id", "Kind");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,KindOfAnimalId,Name")] Breed breed)
        {
